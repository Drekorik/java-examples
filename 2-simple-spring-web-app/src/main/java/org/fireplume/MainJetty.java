...
/**
 * Created by cloudjumper on 6/21/17.
 */
public class MainJetty {
    ...
    public static void main(String[] args) throws Exception {
        new MainJetty().startJetty(getPortFromArgs(args));
    }
...
//        contextHandler.setResourceBase(new ClassPathResource("src/main/resources").getURI().toString());
